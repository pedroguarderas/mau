...
```{r,eval=TRUE, fig.show='hold', fig.align="center", fig.width=5, fig.height=5}
...
6. Sensitivity simulation of weights. Simulation based in the Dirichlet distribution
```{r,eval=TRUE, fig.show='hold', fig.show='hold', fig.align="center", fig.width=6, fig.height=4}
n<-200
