...
The MAUT models defined with aid of utility functions $u_1,\ldots,u_n$ and indexes represented 
simmilarly by $x_1,\ldots,x_n$ and obtain the final utility given by
\[
